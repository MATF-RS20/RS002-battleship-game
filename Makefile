#############################################################################
# Makefile for building: BattleshipGameProject
# Generated by qmake (3.1) (Qt 5.13.2)
# Project:  BattleshipGameProject.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile BattleshipGameProject.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
SOURCES       = Game/Ships/FactoryMethod/ShipFactory.cpp \
		...
		Template/Shoot.cpp moc_mainwindow.cpp
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		BattleshipGameProject.pro Game/Board/IBoard.hpp \
		Game/IGame.hpp \
		...
		Template/TurnTypes/HumanTurn.hpp Game/Ships/FactoryMethod/ShipFactory.cpp \
		Game/Ships/ShipTypes/Carrier.cpp \
		main.cpp \
		mainwindow.cpp \
		Game/Ships/ShipTypes/Cruiser.cpp \
...
BattleshipGameProject: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: BattleshipGameProject.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile BattleshipGameProject.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
all: Makefile BattleshipGameProject
...
ShipFactory.o: Game/Ships/FactoryMethod/ShipFactory.cpp Game/Ships/FactoryMethod/ShipFactory.hpp \
		Game/Ships/IShip.hpp \
		Game/Ships/ShipTypes/Carrier.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ShipFactory.o Game/Ships/FactoryMethod/ShipFactory.cpp

Carrier.o: Game/Ships/ShipTypes/Carrier.cpp Game/Ships/ShipTypes/Carrier.hpp \
		Game/Ships/IShip.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Carrier.o Game/Ships/ShipTypes/Carrier.cpp
...
mainwindow.o: mainwindow.cpp Game/Player/Player.hpp \
		Game/Player/IPlayer.hpp \
		Game/Board/IBoard.hpp \
		Game/Ships/IShip.hpp \
		Game/Game.hpp \
...
Cruiser.o: Game/Ships/ShipTypes/Cruiser.cpp Game/Ships/ShipTypes/Cruiser.hpp \
		Game/Ships/IShip.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Cruiser.o Game/Ships/ShipTypes/Cruiser.cpp

Battleship.o: Game/Ships/ShipTypes/Battleship.cpp Game/Ships/ShipTypes/Battleship.hpp \
		Game/Ships/IShip.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Battleship.o Game/Ships/ShipTypes/Battleship.cpp

Submarine.o: Game/Ships/ShipTypes/Submarine.cpp Game/Ships/ShipTypes/Submarine.hpp \
		Game/Ships/IShip.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Submarine.o Game/Ships/ShipTypes/Submarine.cpp

Destroyer.o: Game/Ships/ShipTypes/Destroyer.cpp Game/Ships/ShipTypes/Destroyer.hpp \
		Game/Ships/IShip.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Destroyer.o Game/Ships/ShipTypes/Destroyer.cpp

Board.o: Game/Board/Board.cpp Game/Board/Board.hpp \
		Game/Board/IBoard.hpp \
		Game/Ships/IShip.hpp \
		Game/Board/Position.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Board.o Game/Board/Board.cpp

Player.o: Game/Player/Player.cpp Game/Player/Player.hpp \
		Game/Player/IPlayer.hpp \
		Game/Board/IBoard.hpp \
		Game/Ships/IShip.hpp \
		Game/Board/Board.hpp \
		Game/Board/Position.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Player.o Game/Player/Player.cpp
...
TurnFactory.o: Template/FactoryMethod/TurnFactory.cpp Template/FactoryMethod/TurnFactory.hpp \
		Game/Player/IPlayer.hpp \
		Game/Board/IBoard.hpp \
		Game/Ships/IShip.hpp \
		Template/FactoryMethod/Turn.hpp \
		Game/Board/Position.hpp \
		Template/Shoot.hpp
...
Turn.o: Template/Turn.cpp Template/Turn.hpp \
		...
		Game/Board/Position.hpp \
		Template/Shoot.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Turn.o Template/Turn.cpp

ComputerTurn.o: Template/TurnTypes/ComputerTurn.cpp Template/TurnTypes/ComputerTurn.hpp \
		Template/Turn.hpp \
		Game/Player/IPlayer.hpp \
		Game/Board/IBoard.hpp \
		Game/Ships/IShip.hpp \
...
HumanTurn.o: Template/TurnTypes/HumanTurn.cpp Template/TurnTypes/HumanTurn.hpp \
		...
		Game/Board/Position.hpp \
		Template/Shoot.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o HumanTurn.o Template/TurnTypes/HumanTurn.cpp

Shoot.o: Template/Shoot.cpp Template/Shoot.hpp \
		Game/Board/Position.hpp \
		Game/Board/IBoard.hpp \
		Game/Ships/IShip.hpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/BattleshipGameProject/bin || mkdir -p $(INSTALL_ROOT)/opt/BattleshipGameProject/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/BattleshipGameProject/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/BattleshipGameProject/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/BattleshipGameProject/bin/ 
